...
{
    // DraggableBlock is a draggable puzzle piece that the player picks up and drops into SlotControl
    // slots. It extends Panel and contains a centered text label displaying the block's code text.
    // The block also has a tag that can match with the slot
